#!/usr/bin/env python3
"""Small release contract check for the V3 NeonPocket target."""
...
require(
    ...
    "[env:heltec_v3_neonpocket_companion_ble]",
    "-D DISPLAY_CLASS=SSD1306Display",
    "-D DISPLAY_REQUIRED=1",
    "-D NEONPOCKET_MONO_UI=1",
    "-D NEONPOCKET_DEVICE_LABEL='\"HELTEC V3 BLE\"'",
...
print("V3 NeonPocket mono contract verified")
